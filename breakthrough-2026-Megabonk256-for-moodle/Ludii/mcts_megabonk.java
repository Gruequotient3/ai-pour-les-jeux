...
public class mcts_megabonk extends AI
{		
	public final static int EMPTY = 0;
	public final static int BLACK = 1;
	public final static int WHITE = 2;
	public final static String local_player_str = "/Users/n/LudiiPlayers/mcts_megabonk";

	protected int player = -1; // player_index
	
	public mcts_megabonk()	{
			this.friendlyName = "mcts_megabonk";
	}
